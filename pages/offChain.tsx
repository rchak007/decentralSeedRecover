...
const decentralSeedPlutus = "584d584b01000022225333573466ebcd5d0991aab9e37540020086ae84c8d55cf1baa001004149854cd5ce24811e646174756d20616e6420706172616d2061726520646966666572656e7420001601"
...
const offChain: NextPage = () => {
  ...
  const sLockEncryptedSeedPhrase = async () => {
    if (lucid) {
      ...
      console.log("hashed info = ", hashedData)


      const paramInit :  Params = [{
        pInfoHash: fromText(hashedData)
      }];
      ...
      const seed23Words = 'custom help female park blush clutch fancy lion fence innocent rebuild amount tip custom help female park blush clutch fancy lion fence innocent 10';   // for now 13 words
      ...
      const datumInit : MyDatum = 
          {
            ...
            encryptedWordsWithIndex: fromText(encryptedString),
      ...
      const tx = await lucid.newTx()
        ...
        console.log("Went into sLockEncryptedSeedPhrase module:After payto ") 
  ...
  const sDecentralSeedRedeem = async () => {
      if (lucid) {
        ...
        const paramInit :  Params = [{
          pInfoHash: paymentCredential?.hash!
        }];
